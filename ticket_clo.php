...
<div class="panel_with_buttons panel panel-default table-responsive">
    <div class="panel-heading clearfix">
        <h1 class="panel-title pull-left"><i class="fas fa-ticket-alt left-menu-icons-account"></i> Tickets cloturés</h1>
		...
		<div class="btn-group pull-right">
                <a class="btn btn-warning" href="manage_ticket.php" role="button">
                    <span class="far fa-clock"></span> Tickets en cours
                </a>
        </div>
    </div>
...
<table class="table table-striped table-bordered table-responsive" width="100%">
	...
	<?php foreach ($table as $row ) {
		  if($row["tck_del"]==0 && $row["intervenantCloture"]=="oui") {?>
	<tr>
